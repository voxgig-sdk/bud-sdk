# Bud JavaScript SDK Reference

Complete API reference for the Bud JavaScript SDK.
...
**Returns:** `BudSDK` instance in test mode.
...
Return the parent `BudSDK` instance.
