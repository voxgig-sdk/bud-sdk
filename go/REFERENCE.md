# Bud Golang SDK Reference

Complete API reference for the Bud Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *BudSDK`
...
#### `Account(data map[string]any) BudEntity`
