...
import (
	...
	vs "github.com/voxgig-sdk/bud-sdk/go/utility/struct"
)
...
func (sdk *BudSDK) OptionsMap() map[string]any {
...
func (sdk *BudSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *BudSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *BudSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BudSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *BudSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *BudSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("BudSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *BudSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BudSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("BudSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *BudSDK) Account(data map[string]any) BudEntity {
