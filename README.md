...
Bud Financial Accounts API client, generated from the OpenAPI spec.

List and read Bud open-banking financial accounts.

Learn more about Bud Financial Accounts API at [thisisbud.com](https://thisisbud.com).

This is an unofficial SDK for the Bud Financial Accounts public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| **Account** | The Account entity (list, load). | `/accounts` |
...
- Upstream API: [https://api-sandbox.thisisbud.com/financial/v2](https://api-sandbox.thisisbud.com/financial/v2)
...
Generated from the Bud Financial Accounts API OpenAPI spec by [@voxgig/sdkgen](https://github.com/voxgig/sdkgen).
