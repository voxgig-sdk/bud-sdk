...
func registerTools(server *mcp.Server, client *sdk.BudSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "bud_list",
		Description: "List records from Bud. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "bud_load",
		Description: "Load a single record from Bud. " +
...
func runOp(client *sdk.BudSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BudSDK, name string) (sdk.BudEntity, error) {
