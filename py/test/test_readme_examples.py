# Bud SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BudSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BudSDK(...) and BudSDK.test(...) become
#      BudSDK.test({"entity": {...}}) seeding one mock record (id "test01")
