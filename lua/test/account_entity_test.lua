...
describe("AccountEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set BUD_TEST_ACCOUNT_ENTID JSON to run live")
      return
    end
...
function account_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("BUD_TEST_ACCOUNT_ENTID")
  ...
  if env["BUD_TEST_LIVE"] == "TRUE" then
  ...
  local live = env["BUD_TEST_LIVE"] == "TRUE"
  return {
    client = client,
    data = entity_data,
