...
BudSDK._make_feature = _make_feature


function BudSDK.new(options)
  local self = setmetatable({}, BudSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function BudSDK:get_utility()
  return Utility.copy(self._utility)
end


function BudSDK:get_root_ctx()
  return self._rootctx
end


function BudSDK:prepare(fetchargs)
...
function BudSDK:direct(fetchargs)
...
-- by passing it.
function BudSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function BudSDK:graphql(query, variables, ctrl)
...
function BudSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
