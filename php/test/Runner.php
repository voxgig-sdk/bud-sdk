...
class BudTestRunner
{
    ...
    {
        $live = self::getenv('BUD_TEST_LIVE');
        $override = self::getenv('BUD_TEST_OVERRIDE');
        ...
        $explain = self::getenv('BUD_TEST_EXPLAIN');
...
class_alias('BudTestRunner', 'Runner');
class_alias('BudHelpers', 'Helpers');
