...
// Bud SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BudSDK::test)
...
{
    private const SDK_CLASS = 'BudSDK';
    ...
    private const SDK_BASE = 'bud_sdk';
