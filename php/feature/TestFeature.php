...
// Bud SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class BudTestFeature extends BudBaseFeature
{
    ...
    public function init(BudContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (BudContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (BudContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(BudContext $ctx, $op, $args): array
    {
