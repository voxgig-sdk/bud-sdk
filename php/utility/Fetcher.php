...
class BudFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BudSDK/1.0)';
    ...
    public static function call(BudContext $ctx, string $fullurl, array $fetchdef): array
    {
