...
|---|---|---|
| `js/` | @voxgig-sdk/bud-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/bud | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/bud-js \
      --repository voxgig-sdk/bud-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/bud-js` shows it, and
`npm trust revoke @voxgig-sdk/bud-js --id=<id>` removes it.
