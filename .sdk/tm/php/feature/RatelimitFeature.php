...
class BudRatelimitFeature extends BudBaseFeature
{
    ...
    private function _acquire(BudContext $ctx): void
    {
    ...
    private function _track(BudContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
