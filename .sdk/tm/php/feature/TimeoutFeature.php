...
class BudTimeoutFeature extends BudBaseFeature
{
    ...
    private function _with_timeout(BudContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BudContext $_ctx, float $ms): void
    {
        $client = $this->client;
