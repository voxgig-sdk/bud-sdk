...
// Bud SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class BudMakeRequest
{
    public static function call(BudContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new BudResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new BudResponse($fetched);
        } else {
