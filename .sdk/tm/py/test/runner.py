...
class BudTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = BudTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = BudTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = BudTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
