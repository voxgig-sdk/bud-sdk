...
from projectname_sdk import BudSDK
from projectname_sdk.core.spec import BudSpec
from projectname_sdk.core.result import BudResult
from projectname_sdk.core.response import BudResponse
from projectname_sdk.core.operation import BudOperation
from projectname_sdk.core.error import BudError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import BudBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = BudSDK.test(None, None)
        ...
        class TestInitFeature(BudBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(BudBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = BudSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = BudSDK.test(None, setup_opts)
